...
<a href="https://render.com/deploy?repo=https://github.com/adamshiervani/trigger-test-email">
...
```sh
git clone https://github.com/adamshiervani/trigger-test-email.git
cd trigger-test-email
npm install
```
